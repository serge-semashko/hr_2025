...
function center_plan(constr_id, floornum, room_id,coord) {
        
        setTimeout(center_plan_2, 100, constr_id, floornum, room_id,coord);
}

function center_plan_2(constr_id, floornum, room_id,coord) {

    let aa = $('[id=' + floornum + '][name=floornum]');
    console.log('[id=' + floornum + '][name=floornum]'+aa);
    aa.click();
    addRooms();
